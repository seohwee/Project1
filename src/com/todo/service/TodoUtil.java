...
public class TodoUtil {
	...
	public static void createItem(TodoList l) {
		int id = 1;
		int is_completed = 0;
		String title, desc, category, due_date, importance, alarm;
		...
		System.out.print("알람시간 > ");
		alarm = sc.nextLine().trim();
		
		TodoItem t = new TodoItem(id, title, is_completed, desc, category, due_date, importance, alarm);
		if(l.addItem(t)>0) { 
	...
	public static void updateItem(TodoList l) {
		...
		String new_title, new_desc, new_category, new_due_date, new_importance, new_alarm;
		Scanner sc = new Scanner(System.in);
		...
		System.out.print("알람시간 > ");
		new_alarm = sc.nextLine().trim();
		
		TodoItem t = new TodoItem(id, new_title, new_is_completed, new_desc, new_category, new_due_date, new_importance, new_alarm);
		t.setId(index);
		if(l.updateItem(t) > 0) {
	...
	public static void completeMultiItem(TodoList l) {
		...
		Scanner sc = new Scanner(System.in);
		System.out.print("[여러 항목 완료 체크]\n" + "완료한 항목의 개수를 입력하시오 > ");
		int input = sc.nextInt();
		
		for(int i=0; i<input; i++) {
			System.out.print("완료 체크할 항목의 번호를 입력하시오 > ");
	...
	public static void dateSchedule(TodoList l) {
